...
func GenerateTextOtherInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelRatio, groupRatio, completionRatio float64,
	...
	if gr := relayInfo.PriceData.GroupRatioInfo; gr.DedicatedModelSource != "" {
		other["dedicated_model_ratio"] = gr.DedicatedModelRatio
		other["dedicated_model_ratio_source"] = gr.DedicatedModelSource
	}
...
func GenerateMjOtherInfo(relayInfo *relaycommon.RelayInfo, priceData hosttypes.PriceData) map[string]interface{} {
	...
	if priceData.GroupRatioInfo.DedicatedModelSource != "" {
		other["dedicated_model_ratio"] = priceData.GroupRatioInfo.DedicatedModelRatio
		other["dedicated_model_ratio_source"] = priceData.GroupRatioInfo.DedicatedModelSource
	}
